...
export interface ApiAkutalnosciAkutalnosci extends Schema.CollectionType {
  collectionName: 'akutalnoscis';
  info: {
    singularName: 'akutalnosci';
    pluralName: 'akutalnoscis';
    displayName: 'Akutalnosci';
    description: '';
  };
  options: {
  ...
  attributes: {
    ...
    PlikDoPobrania: Attribute.Media<'images' | 'files' | 'videos' | 'audios'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiDoPobraniaDoPobrania extends Schema.SingleType {
  ...
  attributes: {
    ...
    Plik: Attribute.Media<'images' | 'files' | 'videos' | 'audios', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiDokumentyDokumenty extends Schema.CollectionType {
  ...
  attributes: {
    ...
    kolorowy: Attribute.Media<'images' | 'files' | 'videos' | 'audios'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    czarnobialy: Attribute.Media<'images' | 'files' | 'videos' | 'audios'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::akutalnosci.akutalnosci': ApiAkutalnosciAkutalnosci;
